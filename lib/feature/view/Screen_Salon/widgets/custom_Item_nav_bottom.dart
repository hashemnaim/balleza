...
class _CustomBottomAppBarState extends State<CustomBottomAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> items = List.generate(widget.items.length, (int index) {
      return _buildTabIcon(index: index, item: widget.items[index], onPressed: _updateIndex);
    });
               ...
               //  contoller.indexNav==index?Colors.white:Colors.transparent,
                 child: Column(
                   children: [
                     ...
                     Icon(item.icon,color: appGet.indexNav==index?AppColors.primaryColor:Colors.black),
